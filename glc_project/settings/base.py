...
MATERIAL_ADMIN_SITE = {
    ...
    'FAVICON':  '/static/image/church.png',  # Admin site favicon (path to static should be specified)
    ...
    'PROFILE_BG':  '/static/image/background3.jpg',  # Admin site profile background (path to static should be specified)
    'LOGIN_LOGO':  '/static/image/logo.jpg',  # Admin site logo on login page (path to static should be specified)
    'LOGOUT_BG':  '/static/image/background.jpeg',  # Admin site background on login/logout pages (path to static should be specified)
